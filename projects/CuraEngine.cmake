...
if(BUILD_OS_WINDOWS)
    set(extra_cmake_args -DArcus_DIR=${CMAKE_PREFIX_PATH}/lib-mingw/cmake/Arcus
						 ...
						 -DProtobuf_LIBRARY="${CURA_BUILD_ENV_PATH}/lib-mingw/libprotobuf.a"
						 -DProtobuf_LITE_LIBRARY="${CURA_BUILD_ENV_PATH}/lib-mingw/libprotobuf-lite.a"
						 -DProtobuf_PROTOC_LIBRARY="${CURA_BUILD_ENV_PATH}/lib-mingw/libprotoc.a"
	)
