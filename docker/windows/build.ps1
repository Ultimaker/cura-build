...
param (
# Docker parameters
  [string]$DockerImage = "ultimaker/cura-build-environment:win1809-WIP",
...
& docker.exe run $dockerExtraArgs `
  ...
  $DockerImage `
  powershell.exe -Command cmd /c "C:\cura-build-src\docker\windows\build_in_docker_vs2015.cmd"
