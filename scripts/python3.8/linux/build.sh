...
CURA_BUILD_ENV_DOCKER_IMAGE="${CURA_BUILD_ENV_DOCKER_IMAGE:-ultimaker/cura-build-environment:centos7-python3.8-qt5.15.2}"
...
CURA_VERSION_MAJOR="${CURA_VERSION_MAJOR:-9}"
CURA_VERSION_MINOR="${CURA_VERSION_MINOR:-9}"
CURA_VERSION_PATCH="${CURA_VERSION_PATCH:-9}"
CURA_VERSION_EXTRA="${CURA_VERSION_EXTRA:-Python3.8-Qt5.15.2}"
