...
export CURA_IS_ENTERPRISE="${CURA_IS_ENTERPRISE}"
...
export CURA_ENABLE_DEBUG_MODE="${CURA_ENABLE_DEBUG_MODE:-yes}"
export CURA_ENABLE_CURAENGINE_EXTRA_OPTIMIZATION_FLAGS="${CURA_ENABLE_CURAENGINE_EXTRA_OPTIMIZATION_FLAGS:-yes}"
